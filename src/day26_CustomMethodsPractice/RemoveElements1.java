...
public class RemoveElements1 {
    public static void main(String[] args) {
        ...
        numbers= removeElement(numbers, 6);//{100,300,400,500,600}
    ...
    public static int[] removeElement(int[]array, int index){
        ...
        for (int i=0; i<array.length;i++) {
            if(i==index){
                continue; //indexe esit olan elementi skip edecek ve yazdirmayacak
            }
            result[j++]=array[i]; //remove ettigi element disindakileri yeni arraye yazdirmak icin j atadik ve onunla yeni arraye ekliyoruz
