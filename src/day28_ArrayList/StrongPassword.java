...
public class StrongPassword {
    ...
    public static boolean isStrongPassword (String password){
        ...
        for (char each : chars) {
            ...
            if(r2&&r3&&r4&r5){ //r2 r3 r4 ve r5 sartini karsiladigi durumda diger karakterleri de kontrol etmesine gerek kalmamasi icin
                break;          // sart degil ama hizli olmasini saglar
            }
