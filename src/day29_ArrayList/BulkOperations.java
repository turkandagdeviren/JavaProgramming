...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(1,2,3,4,5,6,7,3,3,5,5,5,8,8,3,3,5));
        System.out.println(list);

        list.removeAll(Arrays.asList(3,5,8)); //listedeki butun 3 5 8 leri siler
        System.out.println(list);
        ...
        numbers.retainAll(Arrays.asList(100,200,300)); //tum 100 200 ve 300leri tutar kalanini siler
       ...
       namesList.addAll(Arrays.asList(names)); //converting the array to arraylist-1 */
