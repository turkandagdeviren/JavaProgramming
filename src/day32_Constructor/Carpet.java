...
public class Carpet {
    ...
    public double calcCost(){ //bunu hesaplamak icin additional bir bilgiye ihtiyac olmadigi icin parantez icine bisey yazmioruz/yukarda tanimladigimiz icin verilerimiz zaten var
